  ...
  return (
    <section className=" bg-white shadow-lg w-full max-w-xl  max-h-fit p-4 rounded-lg">
      <div className=" grid grid-cols-1 lg:grid-cols-12 gap-3 h-full w-full mt-8">
        <div
          className={`lg:col-span-8 bg-red-300 flex flex-col-reverse gap-2 ${
            changeO && 'lg:flex-row'
          } `}
        >
          <div
            className={`bg-yellow-500 w-full flex  gap-1 ${
          ...
          <div className="bg-gray-200 w-full lg:flex-1 rounded-lg relative overflow-hidden">
            <Image
              fill={true}
              object-fit="cover"
              src={active?.src}
